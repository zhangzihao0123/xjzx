  ...
  <div id="wrapper">
      ...
      <div id="right">
	      ...
	      <div id="welcome">
	        <div>
	           <div class="c1-body">
			                                <c:forEach items="${requestScope.shitiList}" var="shiti" varStatus="sta">
						                        <div class="c1-bline" style="padding:7px 0px;">
							                        <div class="f-left">
							                             <img src="<%=path %>/img/head-mark4.gif" align="middle" class="img-vm" border="0"/> 
							                             <a href="<%=path %>/shitiDetailQian.action?id=${shiti.id }">${shiti.mingcheng }</a>
							                        </div>
							                        <div class="f-right">${shiti.shijian }</div>
							                        <div class="clear"></div>
						                        </div>
						                   </c:forEach>
									  <div class="pg-3"></div>		  
